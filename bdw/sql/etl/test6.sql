set timi on
truncate table bdw_test;

INSERT /*+ APPEND */ INTO bdw_test
    (
-- STORE TABLE
        store_sid,
        store_name,
...
-- SERVICE_USER TABLE
    ...
    WHERE
	    	...
	    	to_date ('08041999', 'MMDDYYYY') and to_date ('08041999 235959', 'MMDDYYYY HH24MISS') OR
--                TO_DATE(''' ||
...
--                        ''DD-MON-YYYY HH24:MI:SS'') OR
	    	...
	    	to_date ('08041999', 'MMDDYYYY') and to_date ('08041999 235959', 'MMDDYYYY HH24MISS')
--                TO_DATE(''' ||
--                    TO_CHAR(i_start_dt, 'DD-MON-YYYY HH24:MI:SS') || ''',
--                        ''DD-MON-YYYY HH24:MI:SS'') AND
--                TO_DATE(''' ||
